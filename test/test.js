...
describe('Test: .is', function() {
	...
	describe('Track @ usps(\'9405903699300184125060\')', function() {
		...
		it('Expect return true', function(done) {
			Courier.usps('9405903699300184125060', function(error, uspsResult) {						
				var result = uspsResult;
	...
	describe('Track @ hkpost(\'CP889331175HK\')', function() {
		...
		var hkpost = {
			checkpoints: [{
				...
				country_name: 'HK',
				message: 'In transit.',
				checkpoint_time: '2013-12-11T00:00:00' // Modified as of what I saw from Hong Kong Post web site
			}, {
				country_name: 'HK',
				...
				country_name: 'NZ',
				message: 'In transit.',
				checkpoint_time: '2014-01-14T00:00:00' // Modified as of what I saw from Hong Kong Post web site
			}, {
				country_name: 'NZ',
				message: 'Delivered.',
				checkpoint_time: '2014-01-15T00:00:00' // Modified as of what I saw from Hong Kong Post web site
			}]
		};

		it('Expect return true', function(done) {
			Courier.hkpost('CP889331175HK', function(error, hkpostResult) {
				var result = hkpostResult;
...
describe('Track @ dpduk(\'15502370264989N\')', function() {
		...
		it('Expect return true', function(done) {
			Courier.dpduk('15502370264989N', function(error, dpdukResult) {
				var result = dpdukResult;
